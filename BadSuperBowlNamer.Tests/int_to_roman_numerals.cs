...
namespace BadSuperBowlNamer.Tests
{
    ...
    {
        [Fact] // this indicates the following method is a test
        public void translating_1_results_in_I() //test methods only return void
        {
            // Arrange
            var number = 1;
        ...
        [Fact] 
        public void translating_3_results_in_III() //test methods only return void
        {
            // Arrange
            var number = 3;
